...
public class Controller {
    ...
    void add(ActionEvent event) {
        ...
        try {
            ...
            if (name.matches("[0-9]+")) {
                str.append("Please only input letters for employee name.");
                str.append("\n");
                TextAreaID.setText(str.toString());
                return;
            }

            else if (nameFieldID.getText().isEmpty()) {
                ...
                TextAreaID.setText(str.toString());
                return;
            } else if (DateHiredID.getValue() == null) {
            ...
            if (fullTimeRadioID.isSelected()) {
                ...
                if (CSRadioID.isSelected()) {
                    ...
                    str.append("\n");
                    str.append("Please choose a department.");
                    TextAreaID.setText(str.toString());
                }
                ...
                if (CSRadioID.isSelected()) {
                    ...
                    deptName = ITRadioID.getText(); //finding ITRadioButton label name and set that to deptname
                    addPartTimeEmployee(hourlyPay);

                } else if (ECERadioID.isSelected()) {
                    deptName = ECERadioID.getText(); //finding ECERadioButton label name and set that to deptname
                    addPartTimeEmployee(hourlyPay);
                } else if (!(CSRadioID.isSelected() && ITRadioID.isSelected() && ECERadioID.isSelected())) {
                    str.append("\n");
                    str.append("Please choose a department.");
                ...
                if (role == 0) {
                    str.append("\n");
                    str.append("Please choose a manager type.");
                    TextAreaID.setText(str.toString());
                }
            ...
            str.append("Please input or check the hours, rate, or annual salary with correct number value.");
            TextAreaID.setText(str.toString());
    ...
    private void addMngmntEmployee() {
        ...
        if (annualSalary < 0) {
            ...
            if (companyDB.add(mngmntEmp)) {
                ...
                str.append("Employee is already in the list.");
            }
            TextAreaID.setText(str.toString());
        } else {
            if (!TextAreaID.getText().isEmpty()) {
    ...
    void setHours(ActionEvent event) {
        ...
        try {
            ...
            str.append("\n");
            str.append("Please enter a correct number value for hours worked.");
            TextAreaID.setText(str.toString());
        ...
        try {
            ...
            while (readFile.hasNextLine()) {
                ...
                switch (command) {
                    ...
                    case "F": //handling command add for fulltime
                        name = arrOfStr[1];
                        deptName = arrOfStr[2];
                        dateHiredStr = arrOfStr[3];
     ...
     */
    @FXML
    void exportDB(ActionEvent event) throws FileNotFoundException {
        FileChooser chooser = new FileChooser();
        chooser.setTitle("Open Source File for the import");
